...
class Ui_Dialog(object):
    def setupUi(self, Dialog):
        ...
        self.presetsView = QtWidgets.QListView(Dialog)
        self.presetsView.setGeometry(QtCore.QRect(10, 10, 501, 91))
        self.presetsView.setObjectName("presetsView")
        self.p_id = QtWidgets.QSpinBox(Dialog)
        self.p_id.setGeometry(QtCore.QRect(360, 110, 42, 21))
        self.p_id.setObjectName("p_id")
        self.label = QtWidgets.QLabel(Dialog)
        self.label.setGeometry(QtCore.QRect(280, 110, 71, 20))
        self.label.setObjectName("label")
        self.Imp_preset = QtWidgets.QPushButton(Dialog)
        self.Imp_preset.setGeometry(QtCore.QRect(420, 110, 93, 28))
        ...
        self.pushButton_2.setGeometry(QtCore.QRect(10, 280, 121, 28))
    ...
    def retranslateUi(self, Dialog):
        ...
        self.pushButton_2.setText(_translate("Dialog", "Очистить БД"))
